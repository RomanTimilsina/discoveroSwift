...
class JobTableViewCell: UITableViewCell {
    ...
    let jobNumberLabel = UILabel(text: "", font: OpenSans.regular, size: 14)
    let line =  UIImageView(image:UIImage(named: "line") ,contentMode: .scaleAspectFit, clipsToBounds: true)
    let jobTypeLabel = UILabel(text: "", font: OpenSans.regular, size: 14)
    ...
    lazy var apartmentDescriptionStack = HorizontalStackView(arrangedSubViews: [jobImage, jobNumberLabel, line, jobTypeLabel, UIView()], spacing: 8)
