...
class OnSelectPageView: UIView {
    ...
    let bedroomImage =  UIImageView(image:UIImage(named: "bedroom") ,contentMode: .scaleAspectFit, clipsToBounds: true)
    ...
    lazy var middleAdStack = VerticalStackView(arrangedSubViews: [priceStack, locationStack, apartmentDescriptionStack, adLabel, adDesciptionLabel, showToggleButton], spacing: 8, distribution: .fill)
    //Comments list
