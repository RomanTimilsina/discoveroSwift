...
class CustomAdCell: UITableViewCell {
    
    var handleViewMore: (() -> Void)?
    static var identifier = "AdTableViewCell"
    ...
    func configureData(_ title: String,_ description: String, _ leftImg: UIImage? = nil,_ rightImg: UIImage? = nil) {
